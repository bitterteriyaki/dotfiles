...
hl.animation({ leaf = "windows", enabled = true, speed = 4, bezier = "out_quint", style = "popin 87%" })
hl.animation({ leaf = "workspaces", enabled = true, speed = 4, bezier = "out_quint", style = "slidefadevert" })
hl.animation({ leaf = "windowsMove", enabled = true, speed = 4, bezier = "out_quint" })
